...
from plugins.utils.custom_filters import command, owner_filter, restrict_filter
from plugins.utils.kbhelpers import ikb


@Client.on_message(command("blacklist") & filters.group)
...
@Client.on_message(command("addblacklist") & restrict_filter)
...
@Client.on_callback_query(filters.regex("^rm_allblacklist$"))
